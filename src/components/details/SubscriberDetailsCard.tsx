    ...
    <div className="animate-fadeIn">
      <div className="bg-white rounded-lg shadow-sm mb-6 overflow-hidden">
        <div className="flex border-b">
          <button 
            className={`px-4 py-3 text-sm font-medium ${activeTab === 'chart' ? 'text-black border-b-2 border-publico' : 'text-gray-500'}`}
            onClick={() => setActiveTab('chart')}
          >
            Gráfico de Tendência
          </button>
          <button 
            className={`px-4 py-3 text-sm font-medium ${activeTab === 'factors' ? 'text-black border-b-2 border-publico' : 'text-gray-500'}`}
        ...
        {activeTab === 'chart' && (
          <div className="p-6">
            <div className="mb-6 flex justify-between items-center">
              <div>
                <h2 className="text-lg font-medium mb-1">Probabilidade de Desistência</h2>
          ...
          <div className="p-6">
            <div className="mb-6">
              <div className="flex items-center">
                <h2 className="text-lg font-medium">Probabilidade de Desistência:</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="dashboard-card">
                <div className="flex items-center mb-4">
                  ...
                  <p className="text-xs text-gray-500 ml-2">Aumentam probabilidade de desistência</p>
                </div>
                      ...
                      <th className="text-right pb-3 text-xs font-medium text-gray-500 flex items-center justify-end">
                        ...
                        <TooltipProvider>
                          <Tooltip>
                            ...
                            <TooltipContent>
                              <p className="text-xs">Impacto na probabilidade de desistência</p>
                            </TooltipContent>
                          </Tooltip>
                        </TooltipProvider>
                      </th>
              ...
              <div className="dashboard-card">
                <div className="flex items-center mb-4">
                  ...
                  <p className="text-xs text-gray-500 ml-2">Diminuem probabilidade de desistência</p>
                </div>
                <table className="w-full">
                  <thead>
                    <tr>
